...
class BaseExecutor(six.with_metaclass(ABCMeta, object)):
    ...
    _scheduler = None
    _lock = None
    _logger = logging.getLogger('ringstar.executors')
    ...
    def start(self, scheduler, alias):
        ...
        :param ringstar.schedulers.base.BaseScheduler scheduler: the scheduler that is starting
            this executor
        ...
        self._logger = logging.getLogger('ringstar.executors.%s' % alias)
