...
from ringstar.util import datetime_to_utc_timestamp, utc_timestamp_to_datetime
...
class RedisJobStore(BaseJobStore):
    ...
    def __init__(self, db=0, jobs_key='ringstar.jobs', run_times_key='ringstar.run_times',
