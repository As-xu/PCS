...
from ringstar.schedulers.blocking import BlockingScheduler
from ringstar.util import asbool


class BackgroundScheduler(BlockingScheduler):
    """
    A scheduler that runs in the background using a separate thread
    (:meth:`~ringstar.schedulers.base.BaseScheduler.start` will return immediately).
    ...
    def start(self, *args, **kwargs):
        ...
        self._thread = Thread(target=self._main_loop, name='ringstar')
