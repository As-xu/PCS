...
from staring.schedulers.blocking import BlockingScheduler
from staring.util import asbool


class BackgroundScheduler(BlockingScheduler):
    """
    A scheduler that runs in the background using a separate thread
    (:meth:`~staring.schedulers.base.BaseScheduler.start` will return immediately).
    ...
    def start(self, *args, **kwargs):
        ...
        self._thread = Thread(target=self._main_loop, name='staring')
